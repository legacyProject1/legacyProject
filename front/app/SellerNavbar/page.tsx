        ...
        <ul className="flex justify-center mx-auto space-x-20">
          ...
          <li>
            <div className="group">
              ...
              className="text-2xl font-bold border border-white hover:border-none border-double hover:bg-gradient-to-r from-jaunema to-jaune text-white px-10 py-2 rounded-3xl">Log Out</button>
